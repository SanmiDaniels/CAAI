...
public class MarkAttendance {
    ...
    private static final Logger LOGGER = Logger.getLogger(MarkAttendance.class.getName());
    ...
    public MarkAttendance() {
        ...
        //System.out.println("This ran yeaaah 47");
    ...
    public String recognizeFromCam() {
       String matricNumber = new String();
        try {
           ...
           // System.out.println("This ran yeaaah 48");
           ...
           // System.out.println("This ran yeaaah 49");
            
            CanvasFrame input = new CanvasFrame("Mark Attendence");
            input.setCanvasSize(180,180);
            input.setDefaultCloseOperation(CanvasFrame.HIDE_ON_CLOSE);
...
//                faceRect.width();
                // Make sure a valid face was detected.
                    //System.out.println("This ran yeaaah 50");
...
//                  Give the image a standard brightness and contrast, in case it was too dark or low contrast.
                    ...
                    //System.out.println("This ran yeaaah 51");
                        continue;
                    }
                    ...
                    if (nEigens > 0) {
                     ...
                     //System.out.println("This ran yeaaah 52");
                    }
                }
                ...
                if (faceRect.width() > 0)// Check if a face was detected.
                {
                    ...
                    if (nEigens > 0 && confidence >= MaxConfidence) // Check if the face recognition database is loaded and a person was recognized.
                    {
                        ...
                        String text = "";
                         ...
                         //System.out.println("This ran yeaaah 53");
                        
                        String name = personNames.get(nearest - 1).toString();
                        //String name = "" + arr[0];
                        text = name;
                        cvPutText(shownImg, text, cvPoint(faceRect.x(), faceRect.y() + faceRect.height() + 15), font, textColor);
//get the matric number here
                        matricNumber = getOrgnlName(name);
                        break;
                        //String [] mainStd = arr[1].split("_");
                        //String std = mainStd[0]+" "+mainStd[1];
    ...
    public IplImage resizeImage(IplImage origImg, int newWidth, int newHeight) {
        try {
            ...
            if (!(origImg == null)) {
             ...
             //System.out.println("This ran yeaaah 54");
...
//        size=size.width(img.width());
            if (img.depth() != IPL_DEPTH_8U) {
             ...
             //System.out.println("This ran yeaaah 55");
...
//            CvMemStorage storage = null;
            ...
            cvClearMemStorage(storage);
             ...
             //System.out.println("This ran yeaaah 56");
...
//            cvReleaseMemStorage(storage);
    ...
    public IplImage convertImageToGreyscale(IplImage imageSrc) {
        try {
          ...
          //   System.out.println("This ran yeaaah 57");
    ...
    private int loadTrainingData1() {
        ...
        // System.out.println("This ran yeaaah 58");
        ...
        if (fileStorage == null) {
         ...
         //System.out.println("This ran yeaaah 59");
        ...
        trainPersonNumMat = new CvMat(pointer);
         ...
         System.out.println("This ran yeaaah 60");
...
//          }
         ...
         //   System.out.println("This ran yeaaah 61");
    ...
    public String modifyName(String name) {
        try {
         ...
         //    System.out.println("This ran yeaaah 62");
    ...
    public String getOrgnlName(String name) {
        try {
            ...
            // System.out.println("This ran yeaaah 63");
...
//        new MarkAttendance().recognizeFromCam();
//    }
}
